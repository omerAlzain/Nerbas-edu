    ...
    function jsonRpc(url, fct_name, params, settings) {
        ...
        return _genericJsonRpc(fct_name, params, settings, function(data) {
            return $.ajax(url, _.extend({}, settings, {
                ...
                dataType: 'json',
                type: 'POST',
/*** this line cann't be used because of the missing dependency (time)**/
...
//                data: JSON.stringify(data, time.date_to_utc),
     ...
     */
     ...
     /*** this function can not be used because of missing dependencies(download and contentdisposition) **/
     ...
     * @returns {Promise}
     */
     /*** this function can be used because of the missing dependency (concurrency)**/
